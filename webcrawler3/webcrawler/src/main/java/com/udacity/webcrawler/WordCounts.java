...
final class WordCounts {
  ...
  static Map<String, Integer> sort(Map<String, Integer> wordCounts, int popularWordCount) {
    ...
    /* Per instructions, ok to use WordCountComparator.
    Per instructions, begin with "return wordCounts.entrySet().stream()".
    The limit of Math.min(popularWordCount, wordCounts.size()) is provided above in original method.
    Per instructions, collect to map.
     */
